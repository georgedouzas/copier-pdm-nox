...
def release(session: nox.Session) -> None:
    ...
    session.run('az', 'repos', 'pr', 'create', '--target-branch', 'main', external=True)
    session.run('az', 'repos', 'pr', 'complete', '--merge-commit-message', f'Release {version}', '--delete-source-branch', external=True)
