...
[ci]: <https://dev.azure.com/gdouzas/test-repo/_build>
[ci badge]: <https://dev.azure.com/gdouzas/test-repo/_apis/build/status/ci?branchName=main>
...
```bash
git clone https://dev.azure.com/gdouzas/test-repo/_git/test-repo
cd test_repo
pdm install
```
