...
[ci]: <https://gitlab.com/gdouzas/test-repo/-/pipelines>
[ci badge]: <https://gitlab.com/gdouzas/test-repo/badges/main/pipeline.svg>
...
```bash
git clone https://gitlab.com/gdouzas/test-repo.git
cd test_repo
pdm install
```
